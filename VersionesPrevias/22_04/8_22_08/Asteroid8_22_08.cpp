        ...
        while (fin==0) //"while" se encargará de cerrar la pantalla
        {
            ...
            if(juego ==1)
            {
                ...
                while(PantallaF == 1)
                {
                    ...
                    {
                        al_draw_scaled_bitmap(fondoPart,0,0,728,410,0,0,1000,700,0);
                        al_draw_text(fuenteSecc,al_map_rgb(255,255,255),370,225,0,"Perdiste ...");
                        ...
                        al_draw_text(fuenteSubt,al_map_rgb(255,255,255),320,560,0," Nombre");
                        al_draw_text(fuentePeque,al_map_rgb(255,255,255),350,620,0,"Max (5 caracteres)");
                    }
                    al_flip_display();
                    switch(evento.type)
                    {
